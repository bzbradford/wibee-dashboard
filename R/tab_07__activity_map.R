    ...
    function(input, output, session) {
      ...
      output$ui <- renderUI({
        ...
        tagList(
          ...
          div(
            class = "plot-caption",
            "This map displays a summary of all the surveys currently selected by your filters. Change your filter selections or choose a different summary type to change what is shown on this map."
          )
        )
      })
