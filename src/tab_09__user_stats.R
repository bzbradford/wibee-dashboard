    ...
    function(input, output, session) {
      ...
      output$ui <- renderUI({
        ...
        tagList(
          ...
          div(
            class = "plot-caption",
            "This graph shows the total number of surveys conducted each year, further grouped by the number of users who have conducted the same amount of surveys. This summary is based on the surveys selected by the main survey filters shown above."
          )
        )
      })
