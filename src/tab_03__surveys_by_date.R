    ...
    function(input, output, session) {
      ...
      output$ui <- renderUI({
        ...
        tagList(
          ...
          div(
            class = "plot-caption",
            "This chart shows the number of surveys completed each week and (optionally) the user ID of the person who conducted the survey, within the date range specified in the data filters above."
          )
        )
      })
